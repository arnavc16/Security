    ...
    $(function()
    {
		...
		function onContentChange(e)
		{
			if(pz != null)
			{
				...
				pz.elem($("<div class='" + contentVal + "Div' data-options='adjustHolderSize:false'><img data-src='assets/" + contentVal + ".jpg' class='optionImg'/><img data-src='assets/red_marker.png' class='marker redMarker' data-elem='marker' data-options='x:760; y:550; transformOrigin:20px 28px; force3D:true' data-tooltip='This is marker 1'/><img data-src='assets/red_marker.png' class='marker redMarker' data-elem='marker' data-options='x:570; y:250; transformOrigin:20px 28px; force3D:true' data-tooltip='This is marker 2'/></div>"), false, false);
